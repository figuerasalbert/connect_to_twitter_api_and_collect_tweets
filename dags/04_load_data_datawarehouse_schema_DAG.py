...
def datawarehouse_db(ti):
    ...
    sql_create_table = "CREATE TABLE IF NOT EXISTS weekly_tweets (code INT, FOREIGN KEY (code) REFERENCES store_player_bios(code), id_tweet INT PRIMARY KEY, twitter_user VARCHAR(255)," \
